    ...
    <div className="min-h-screen bg-[#fafafa] flex flex-col overflow-hidden">
      <div className="absolute top-4 right-4 z-10 flex items-center gap-2">
        {text.trim() && (
          <button
            ...
            className="opacity-30 hover:opacity-70 transition-opacity duration-200 text-gray-500 hover:text-gray-700 flex items-center gap-1 text-xs font-[family-name:var(--font-geist-mono)]"
        ...
        <span className="text-xs text-gray-400 font-[family-name:var(--font-geist-mono)]">{dateStr}</span>
      </div>
      ...
      <div className="flex-1 px-8 flex justify-center">
        <textarea
          ...
          className="w-1/2 h-full resize-none border-none outline-none bg-transparent text-gray-800 text-base leading-relaxed placeholder-slate-300 font-[family-name:var(--font-geist-mono)] pt-8"
          style={{ minHeight: "calc(100vh - 48px)" }}
        />
      </div>

      <div className="p-4">
        <span className="text-xs text-gray-400 font-[family-name:var(--font-geist-mono)]">
